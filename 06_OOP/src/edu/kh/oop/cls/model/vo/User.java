...
public class User {
	...
	public User(String userId, String userPw) {
		...
		public User (String userId, String userPw, String userName,
				    int userAge, char userGensder) {
			
		// this() 생성자
		// 같은 클래스의 다른 생성자를 호출할 때 사용
		// 생성자 내에서 반드시 첫번째 줄에 작성해야한다!
		// 왜 사용하는가?
		// 중복코드 제거, 코드 길이 감소, 재사용 증가...
	...
	public User(String userId) {} // 매개변수의 개수가 같은 생성자
	// -> 오버로딩 성립
	...
	// public User(String userAge, int userName) {} // 에러
